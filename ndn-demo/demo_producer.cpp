...
void
Demo_Producer::AddPrefix(std::string prefix)
{
	//  to-do
}

void
Demo_Producer::AddRoute(std::string prefix)
{
	//  to-do
}

void
Demo_Producer::SendInterest(std::string prefix)
{
...
Demo_Producer::OnInterest(std::shared_ptr<const ndn::Interest> interest)
{
  ...
  std::string demo_reply_string = "/prefix/rep";
  ...
  {
	this->SendInterest(demo_reply_string);
  }
